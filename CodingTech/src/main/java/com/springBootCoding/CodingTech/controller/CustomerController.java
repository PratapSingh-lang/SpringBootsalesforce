...
public class CustomerController {
     ...
     */
    @ApiOperation(value = "Create a new customer", notes = "Creates a new customer in the system.")
    @ApiResponses(value = {
     ...
     */
    @ApiOperation(value = "Get a customer by ID", notes = "Retrieves a customer from the system based on the provided ID.")
    @ApiResponses(value = {
     ...
     */
    @ApiOperation(value = "Get all customers", notes = "Retrieves all customers from the system.")
    @ApiResponses(value = {
     ...
     */
    @ApiOperation(value = "Update a customer by ID", notes = "Updates an existing customer in the system based on the provided ID.")
    @ApiResponses(value = {
     ...
     */
    @ApiOperation(value = "Delete a customer by ID", notes = "Deletes a customer from the system based on the provided ID.")
    @ApiResponses(value = {
